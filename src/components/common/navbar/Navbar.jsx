    ...
    >
      ...
      <header className="flex justify-around">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="lg:flex items-center justify-end lg:w-auto hidden">
            <Link
              href="/contact"
              className="animate__animated animate__pulse animate__infinite animate__slower bg-secondary text-white text-lg px-7 py-3 font-medium text-dark hover:opacity-70 dark:text-white md:block whitespace-nowrap"
            >
              Book Online
            </Link>
          </div>
